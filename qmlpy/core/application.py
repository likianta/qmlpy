...
class Application(QApplication):
    ...
    def __init__(self, app_name='QmlPy Demo', **kwargs):
        """
        args:
            app_name: str
                set application name.
                the name can also be changed by `self.set_app_name`.
            kwargs:
                organization: str. default is 'dev.likianta.qmlpy'.
                    set an organization name, it suppresses error from `QtQuick
                    .Dialogs.FileDialog`.
        ...
        self.setOrganizationName(kwargs.get(
            'organization', 'dev.likianta.qmlpy'
        ))
