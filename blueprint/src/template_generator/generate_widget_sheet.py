...
#                       + '/qmlpy/properties/prop_sheet/ext.py'
DEFAULT_OUTPUT_FILE = io.project_dir \
                      + '/qmlpy/widgets/widget_sheet.py'
...
def main(output_file: TPath = DEFAULT_OUTPUT_FILE):
    ...
    #
    #     from qmlpy import properties as P  # noqa
    #
    #
    #     {WIDGETS}
    # ''')
    template = dedent('''
        """
        - This module is auto generated by `qmlpy/blueprint/src/template
          _generator/create_widget_sheet.py`.
        - Please do not edit this file directly.
        - (For developer) this module shouldn't be imported by `qmlpy.properties
          .prop_sheet.__init__`, although it is in the same folder. Otherwise
          it will cause a circular import error.
        - The prefix 'Ps' means 'qmlpy.properties.prop_sheet.PropSheet'.
        - The prefix 'P' means 'qmlpy.properties'.
        """
        from typing import Union
